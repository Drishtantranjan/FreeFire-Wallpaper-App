...
import '../agentOverview/carolineOverview.dart';

class Caroline extends StatefulWidget {
  const Caroline({
    super.key,
  });

  @override
  State<Caroline> createState() => _CarolineState();
}

class _CarolineState extends State<Caroline> {
  Future<List<String>> fetchImages() async {
    final QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('caroline') // Replace 'caroline' with your collection name
        .get();
      ...
      return GestureDetector(
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  CarolineOverview(imageUrl: imageUrls[index]),
            ),
          );
        },
        child: Container(
